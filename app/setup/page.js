                ...
                <div className="max-w-[750px] w-full space-y-6 mb-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className='flex space-x-5'>
                            {[
                                { id: 'student', label: 'Student', gradient: 'from-purple-600 to-blue-500' },
                                { id: 'mentor', label: 'Mentor', gradient: 'from-cyan-500 to-blue-500' },
                                { id: 'teacher', label: 'Teacher', gradient: 'from-green-400 to-blue-600' }
                            ].map((roleOption) => (
                                <button
                                    key={roleOption.id}
                                    type="button"
